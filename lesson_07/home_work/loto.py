...
class card ():
    def __init__ (self):
        ...
        for i in range (self._row_count):
            print (self._number_in_row_count * i)
    ...
    def __str__ (self):
        ...
        for row in range (self._row_count):
            for colum in range (self._column_count):
                if colum in self._distribution_row[self._number_in_row_count * row : self._number_in_row_count * (row + 1)]:
