...
data_calendar = input("введите дату в формате дд.мм.гггг :" ).split('.')

print (days[data_calendar[0]] +' '+ months[data_calendar[1]] +' '+ data_calendar [2] +' '+ 'года')
...
n=int(input('какое количество элементов должно быть в списке ?:'))
my_lst = []
i=0
while i<n:
    my_lst.append(random.randint(-100,100))
    i+=1
print(my_lst)
'''
